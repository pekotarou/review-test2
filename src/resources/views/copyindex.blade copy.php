    ...
    <aside class="sidebar">
        <form class="search-form" action="/products" method="get" >
            ...
            <div class="search-form__item">
                ...
                {{ $sort }}
                @endif
                <input class="search-input" type="text"  name="keyword" placeholder="商品名で検索"  value="{{ $keyword  }}" />
                @else
        ...
        <div class="sort-area">
            ...
            <form method="GET" action="/products" >
                ...
                <select name="sort" onchange="this.form.submit()" class="sort-select">
                    ...
                    <option value="high" {{ request('sort')=='high'?'selected':'' }}>高い順に表示
                    </option>
        ...
        <!-- バツを押したら並べ替えだけリセットされる（キーワード選択している場合は保持される） -->
            <div class="sort-tag">
                ...
                <a href="{{ route('products.index', request()->except('sort')) }}" class="tag-close">
                    ×
                </a>
            </div>
        @endif
